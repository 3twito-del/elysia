...
| ----- | ------------------------------------ | -------------- | -------- | ------ | ---------------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------- |
| I-301 | Public UX and Brand                  | Actionable Now | P1       | M      | `src/app/page.tsx`, `src/components/cinematic-hero-sequence.tsx`                               | Home hero first viewport         | Visible as a short product-name caption over each hero image so shoppers immediately know what jewelry is shown.    | Caption is readable on mobile and desktop without covering the primary CTA.        | Visual smoke on `/`.                     |
...
| I-303 | Public UX and Brand                  | Actionable Now | P2       | S      | `src/components/cinematic-hero-sequence.tsx`                                                   | Home hero slideshow              | Visible as a slim slide progress indicator or numbered state under the hero media.                                  | Reduced-motion users see the current state without animation dependence.           | Component source test plus visual smoke. |
...
| I-305 | Public UX and Brand                  | Actionable Now | P2       | M      | `src/app/page.tsx`, `src/components/product-card.tsx`                                          | Home category shortcuts          | Visible as compact category chips with product counts above the first product rail.                                 | Each chip links to a real category and fits in one horizontal row or scroll strip. | Route-backed source test.                |
| I-306 | Public UX and Brand                  | Actionable Now | P2       | S      | `src/app/page.tsx`, `src/components/service-recovery-link.tsx`                                 | Home service strip               | Visible as a quiet service help band after the first commerce section.                                              | Service entry does not push product cards below the first mobile viewport.         | Visual smoke on `/`.                     |
...
| I-308 | Public UX and Brand                  | Actionable Now | P2       | S      | `src/app/page.tsx`, `src/components/commerce-page-hero.tsx`                                    | Home trust cues                  | Visible as three concise trust notes near the first commerce CTA.                                                   | Notes are factual, short, and do not read like a marketing hero.                   | Copy review and visual smoke.            |
...
| I-336 | Public UX and Brand                  | Actionable Now | P2       | M      | `src/app/search/page.tsx`                                                                      | Search no-results state          | Visible as spelling or category suggestions when a query returns no products.                                       | Suggestions link to real routes or safe search params.                             | No-results smoke.                        |
...
| I-339 | Commerce and Checkout                | Actionable Now | P2       | M      | `src/app/search/page.tsx`                                                                      | Search category tabs             | Visible as category tabs or segmented chips for narrowing results.                                                  | Active category is route-backed and keyboard reachable.                            | Browser smoke.                           |
...
| I-385 | Public UX and Brand                  | Actionable Now | P2       | M      | `src/app/service/page.tsx`                                                                     | Service topic cards              | Visible as topic cards for sizing, delivery, returns, product care, and order help.                                 | Topic choice carries into the form or query string.                                | Service route test.                      |
...
| I-387 | Public UX and Brand                  | Actionable Now | P2       | S      | `src/app/service/page.tsx`                                                                     | Service response expectation     | Visible as a response-time note near the contact form.                                                              | Note is realistic and does not promise unavailable channels.                       | Copy check.                              |
...
| I-393 | Public UX and Brand                  | Actionable Now | P2       | M      | `src/app/branches/page.tsx`                                                                    | Branches contact channels        | Visible as cards for chat, service request, email, or future branch updates.                                        | Each card has one route-backed action.                                             | Branches route smoke.                    |
| I-394 | Public UX and Brand                  | Actionable Now | P2       | S      | `src/app/branches/page.tsx`                                                                    | Branches map placeholder         | Visible as a calm placeholder with an online-service CTA instead of an empty map area.                              | Placeholder is hidden once real branch data exists.                                | Branches visual smoke.                   |
| I-395 | Public UX and Brand                  | Actionable Now | P2       | M      | `src/app/about/page.tsx`                                                                       | About story                      | Visible as a short brand timeline or origin sequence.                                                               | Timeline is scannable and does not block product discovery links.                  | About route smoke.                       |
| I-396 | Public UX and Brand                  | Actionable Now | P2       | S      | `src/app/about/page.tsx`                                                                       | About material facts             | Visible as factual material or sourcing cards with short labels.                                                    | Claims are supportable by local copy or marked as positioning.                     | Copy audit.                              |
| I-397 | Public UX and Brand                  | Actionable Now | P2       | S      | `src/app/about/page.tsx`, `src/app/service/page.tsx`                                           | About care teaser                | Visible as a care-instructions teaser linking to service or FAQ.                                                    | Teaser links to practical help instead of decorative copy only.                    | Route smoke.                             |
