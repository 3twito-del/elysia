...
export function getAiFallbackCopy(reason?: string | null): AiFallbackCopy {
  ...
  if (
    ...
    return {
      ...
      kind: "quota",
      serviceMessage:
        "כלי ההתאמה היה עמוס. אבקש עזרה במציאת תכשיט או מתנה.",
  ...
  if (
    ...
    return {
      detail:
        "אפשר להמשיך דרך החיפוש, מדריך המידות או להשאיר פנייה.",
      kind: "unavailable",
      serviceMessage:
        "כלי ההתאמה לא היה זמין. אבקש עזרה ידנית במציאת תכשיט.",
  ...
  return {
    detail:
      "אפשר להמשיך לחיפוש, לבדוק מידות או לפתוח פנייה קצרה.",
    kind: "unknown",
    serviceMessage:
      "כלי ההתאמה לא השלים את הבקשה. אבקש עזרה במציאת תכשיט.",
