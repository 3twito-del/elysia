...
const privacySections = [
  ...
  },
  {
    ...
    text: "המידע משמש להפעלת האתר, טיפול בהזמנות, אספקה, שירות, ניהול חשבון, התאמת המלצות, שיפור האתר, מניעת הונאות, אבטחת מידע, עמידה בחובות דין ושליחת עדכונים או דיוור כאשר הדבר מותר לפי דין.",
  },
  {
