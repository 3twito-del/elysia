...
const privacySections = [
  ...
  },
  {
    ...
    text: "בעת שימוש באתר עשויים להיאסף פרטי קשר, פרטי הזמנה, כתובת משלוח, פרטי חשבון, פניות שירות, העדפות קטלוג, תוכן שנשלח לסטייליסט החכם ומידע טכני כגון כתובת IP, סוג דפדפן, אירועי שימוש ותיעוד אבטחה.",
  },
  {
    title: "מידע בעל רגישות מיוחדת",
    text: "ככלל, האתר אינו מבקש מידע רגיש שאינו דרוש להזמנה או לשירות. אם משתמש מוסר מיוזמתו מידע שעשוי להיחשב בעל רגישות מיוחדת, למשל במסגרת פנייה לשירות לקוחות או ייעוץ אישי, נעשה בו שימוש רק לצורך הטיפול בפנייה, מתן השירות, אבטחה, עמידה בדין או הגנה על זכויות.",
  },
  {
  ...
  },
  {
    ...
    text: "מידע עשוי להימסר לספקי תשתית, סליקה, משלוחים, דוא״ל, SMS, אחסון, חיפוש, אבטחה, אנליטיקה וספקי בינה מלאכותית, ככל שהדבר נדרש להפעלת השירות. מידע עשוי להימסר גם אם קיימת חובה חוקית, צו שיפוטי, דרישת רשות מוסמכת או צורך להגן על זכויות Elysia והלקוחות.",
  },
  {
    title: "עוגיות ואחסון מקומי",
    text: "האתר משתמש בעוגיות, localStorage וטכנולוגיות דומות לצורך הפעלת שירותים חיוניים כגון סל, התחברות, אבטחה והעדפות נגישות. שימוש במדידה, שיפור חוויית הבחירה ופריטים שנצפו לאחרונה יתבצע רק לאחר בחירת המשתמש בבאנר הקוקיז. ניתן לנהל או למחוק עוגיות דרך הגדרות הדפדפן, אך חלק מהשירותים עשויים להיפגע.",
  },
  {
