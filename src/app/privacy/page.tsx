...
export const metadata: Metadata = {
  ...
  description:
    "מדיניות הפרטיות של Elysia בהתאם לחוק הגנת הפרטיות, לרבות תיקון 13: מידע שנאסף, מטרות שימוש, העברת מידע, אבטחה וזכויות משתמשים.",
};
...
const privacySections = [
  ...
  },
  {
    ...
    text: "בעת שימוש באתר עשויים להיאסף פרטי קשר, פרטי הזמנה, כתובת מסירה, פרטי חשבון, פניות שירות, העדפות מבחר, תוכן שנשלח לסטייליסט החכם ומידע שימוש כגון כתובת IP, סוג דפדפן, אירועי שימוש ותיעוד אבטחה.",
  },
  {
    title: "מידע בעל רגישות מיוחדת",
    text: "ככלל, האתר אינו מבקש מידע רגיש שאינו דרוש להזמנה או לשירות. אם משתמש מוסר מיוזמתו מידע שעשוי להיחשב בעל רגישות מיוחדת, למשל במסגרת פנייה לשירות אישי או ייעוץ אישי, נעשה בו שימוש רק לצורך הטיפול בפנייה, מתן השירות, אבטחה, עמידה בדין או הגנה על זכויות.",
  },
  {
    title: "מטרות השימוש במידע",
    text: "המידע משמש להפעלת האתר, טיפול בהזמנות, אספקה, שירות אישי, ניהול חשבון, התאמת המלצות, שיפור חוויית משתמש, מניעת הונאות, אבטחת מידע, עמידה בחובות דין ושליחת עדכונים או דיוור כאשר הדבר מותר לפי דין.",
  },
  {
    title: "בעל שליטה במאגר ומחזיקים",
    text: "Elysia פועלת כבעלת השליטה במידע שנאסף במסגרת האתר, וספקי שירות חיצוניים עשויים לפעול כמחזיקים או מעבדים מטעמה לצורך מתן השירות. אנו משתדלים להגביל את הגישה למידע למורשים ולספקים הנדרשים לכך בלבד, בהתאם למטרות המפורטות במדיניות זו.",
  },
  {
    title: "מסירת מידע לצדדים שלישיים",
    text: "מידע עשוי להימסר לספקי תשתית, תשלום, מסירה, דוא״ל, SMS, אחסון, חיפוש, אבטחה, אנליטיקה וספקי בינה מלאכותית, ככל שהדבר נדרש להפעלת השירות. מידע עשוי להימסר גם אם קיימת חובה חוקית, צו שיפוטי, דרישת רשות מוסמכת או צורך להגן על זכויות Elysia והלקוחות.",
  },
  {
    title: "עוגיות ואחסון מקומי",
    text: "האתר משתמש בעוגיות, אחסון מקומי וטכנולוגיות דומות לצורך הפעלת שירותים חיוניים כגון הבחירה שלי, התחברות, אבטחה והעדפות נגישות. שימוש במדידה, שיפור חוויית הבחירה ובחירות שנצפו לאחרונה יתבצע רק לאחר בחירת המשתמש בבאנר הקוקיז. ניתן לנהל או למחוק עוגיות דרך הגדרות הדפדפן, אך חלק מהשירותים עשויים להיפגע.",
  },
  {
  ...
  },
  {
    ...
    text: "בהתאם לחוק הגנת הפרטיות, משתמשים רשאים לפנות בבקשה לעיין במידע עליהם, ולבקש תיקון או מחיקה של מידע שאינו נכון, שלם, ברור או מעודכן. בקשות ייבחנו בכפוף להוראות הדין, לאימות זהות, לחובות שמירה חוקיות ולמגבלות מעשיות או משפטיות.",
  },
  {
    title: "קטינים",
