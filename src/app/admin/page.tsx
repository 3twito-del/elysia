...
function AdminDatabaseFallback() {
  return (
    <main>
      <SiteHeader />
      <section className="admin-command-center min-h-[70vh] border-b border-[var(--glass-border)] px-4 py-16 sm:px-6">
        <Card className="purchase-chamber mx-auto max-w-3xl rounded-none border-x-0">
          <CardHeader>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="admin-command-center maison-frame mb-8 flex flex-col gap-5 rounded-md border border-white/10 p-5 shadow-[0_18px_48px_var(--glass-shadow-deep)] lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              ...
              <h1 className="editorial-title text-3xl font-semibold sm:text-4xl">
                ניהול Aphrodite
              </h1>
          ...
          <Card className="admin-panel admin-table-shell mt-8 rounded-md">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
          ...
          <div className="mt-8 grid gap-6 xl:grid-cols-2">
            <Card className="admin-panel admin-table-shell rounded-md">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
