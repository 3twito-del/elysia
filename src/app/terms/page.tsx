...
const termsSections = [
  {
    title: "שימוש באתר",
    text: "השימוש באתר כפוף לתקנון זה, למדיניות הפרטיות ולכל דין. האתר מיועד להצגת מבחר תכשיטים, בירור התאמה, קבלת ייעוץ וביצוע הזמנה אישית.",
  },
  {
    title: "פרטים, התאמה ומחירים",
    text: "אנו עושים מאמץ להציג מידע מדויק על תכשיטים, מחירים, תמונות והתאמה לבחירה. ייתכנו שינויי התאמה, טעויות הקלדה או פערי צבע ותצוגה בין מסכים. במקרה של טעות מהותית, נפעל לעדכן את הלקוח ולהציע תיקון, חלופה או ביטול בהתאם לדין.",
  },
  {
    title: "הזמנות ותשלום",
    text: "הזמנה תושלם רק לאחר קבלת כל הפרטים הנדרשים ואישור התשלום או אמצעי ההזמנה. תשלום מתבצע באמצעות ספקי תשלום ושירותים חיצוניים מאובטחים, בהתאם לתנאים שלהם.",
  },
  {
    title: "מסירה",
    text: "מועדי המסירה ואפשרויות המסירה יוצגו בתהליך ההזמנה או יימסרו על ידי השירות האישי. בשלב זה ההזמנות מתקבלות באתר בלבד. איחורים הנובעים מגורמים חיצוניים יטופלו מול הלקוח בהקדם האפשרי.",
  },
  {
  ...
  },
  {
    ...
    text: "המלצות הסטייליסט החכם ותוכן המדריכים באתר נועדו לסיוע כללי בלבד. בחירה סופית של תכשיט, מידה, התאמה, מחיר או שימוש נעשית באחריות המשתמש, ורצוי לאמת פרטים חשובים מול השירות האישי.",
  },
  {
