...
const termsSections = [
  ...
  },
  {
    ...
    text: "המלצות סטייליסט AI ותוכן מדריכי באתר נועדו לסיוע כללי בלבד. בחירה סופית של מוצר, מידה, התאמה, תקציב או שימוש נעשית באחריות המשתמש, ורצוי לאמת פרטים חשובים מול נציג שירות.",
  },
  {
