...
const termsSections = [
  {
    title: "שימוש באתר",
    text: "השימוש באתר כפוף לתקנון זה, למדיניות הפרטיות ולכל דין. האתר מיועד להצגת קטלוג תכשיטים, בדיקת זמינות, קבלת ייעוץ וביצוע הזמנה אונליין.",
  },
  {
  ...
  {
    title: "משלוחים",
    text: "זמני אספקה ואפשרויות משלוח יוצגו בתהליך ההזמנה או יימסרו על ידי שירות הלקוחות. בשלב זה המכירות מתקיימות אונליין בלבד. איחורים הנובעים מגורמים חיצוניים יטופלו מול הלקוח בהקדם האפשרי.",
  },
  {
  ...
  },
  {
    ...
    text: "המלצות הסטייליסט החכם ותוכן מדריכי באתר נועדו לסיוע כללי בלבד. בחירה סופית של מוצר, מידה, התאמה, תקציב או שימוש נעשית באחריות המשתמש, ורצוי לאמת פרטים חשובים מול נציג שירות.",
  },
  {
