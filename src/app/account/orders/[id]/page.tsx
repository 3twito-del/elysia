      ...
      <RevealSection className="editorial-band signature-grid border-b border-[var(--glass-border)]">
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
          ...
          <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <p className="editorial-eyebrow mb-3">Order detail</p>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
            ...
            <Card className="purchase-chamber rounded-none border-x-0">
              <CardHeader>
            ...
            <Card className="rounded-none border-x-0 bg-transparent lg:col-span-2">
              <CardHeader>
