...
export function StylistChat() {
  ...
  return (
    <div className="grid min-h-[640px] rounded-md border border-black/10 bg-white/65 backdrop-blur">
      <div className="border-b border-black/10 p-5">
        <div className="flex items-center justify-between gap-4">
          <div>
            <Badge className="mb-2 shadow-none" variant="secondary">
              AI Stylist
            </Badge>
      ...
      <div className="flex min-h-0 flex-col">
        ...
        <div className="border-t border-black/10 p-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="grid gap-2">
                  ...
                  <p className="text-muted-foreground leading-6">
                    מכסת ה-AI הזמנית של הספק נוצלה או שהמפתח אינו פעיל. נסו שוב
                    בעוד דקה.
                  </p>
                  <Button
                    className="w-fit"
          ...
          <p className="text-muted-foreground mt-3 text-xs">
            ההמלצות הן כלי עזר. זמינות, מידה והתאמה סופית יאושרו בקופה או בסניף.
          </p>
        </div>
      </div>
    </div>
