    ...
    <>
      {!isTriggerHidden && (
        <Button
          ...
          className="public-floating-control public-floating-trigger bg-background text-foreground focus-visible:outline-foreground/50 fixed right-3 bottom-[calc(max(var(--floating-stack-bottom,0.75rem),var(--public-floating-bar-offset,0.75rem),var(--public-bottom-safe-offset,0.75rem))+env(safe-area-inset-bottom))] left-auto z-50 size-10 rounded-full shadow-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-solid sm:right-5 sm:size-11"
          data-accessibility-widget-trigger="true"
