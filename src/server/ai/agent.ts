...
export const AI_COMMERCE_AGENT_INSTRUCTIONS = [
  ...
  "כאשר המשתמשת מבקשת שילוב, העבירי ל-searchCatalog את כל הקטגוריות ב-categories ואת mode=combination. maxPrice הוא התקציב הכולל לכל פריטי השילוב.",
  "אם המשתמש מבקש לשמור פרופיל סגנון, השתמשי בכלי saveStyleProfile רק אחרי שיש פרטים מפורשים וללא המצאת העדפות.",
  "אם המשתמש מבקש מידה, השתמשי בכלי createTryOnSession רק עבור תכשיט מזוהה מהמבחר.",
