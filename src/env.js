...
export const env = createEnv({
  ...
  server: {
    ...
    SHOPIFY_DROPSHIP_ENABLED: z.enum(["0", "1", "false", "true"]).optional(),
    SHOPIFY_DROPSHIP_SYNC_ENABLED: z
      .enum(["0", "1", "false", "true"])
      .optional(),
    ANALYTICS_INGESTION_ENABLED: z.enum(["0", "1", "false", "true"]).optional(),
    ...
    SHOPIFY_WEBHOOK_SECRET: z.string().min(16).optional(),
  ...
  runtimeEnv: {
    ...
    SHOPIFY_DROPSHIP_ENABLED: process.env.SHOPIFY_DROPSHIP_ENABLED,
    SHOPIFY_DROPSHIP_SYNC_ENABLED: process.env.SHOPIFY_DROPSHIP_SYNC_ENABLED,
    ANALYTICS_INGESTION_ENABLED: process.env.ANALYTICS_INGESTION_ENABLED,
