...
export const seedCategories = [
  {
    slug: "rings",
    name: "טבעות",
    description: "טבעות בכסף 925 ובציפוי זהב, במגוון מידות ועיצובים.",
  ...
  },
  {
    ...
    name: "שרשראות",
    description:
      "שרשראות ותליונים בכסף 925 ובציפוי זהב, כולל פנינים ושיבוצי זירקון.",
  ...
  },
  {
    slug: "earrings",
    name: "עגילים",
    description: "עגילים צמודים, חישוקים ועגילים תלויים, ליום-יום ולמתנה.",
  ...
  },
  {
    slug: "bracelets",
    name: "צמידים",
    description: "צמידים בכסף 925 ובציפוי זהב, כולל צמידי טניס משובצים.",
  ...
  },
  {
    slug: "sets",
    name: "סטים",
    description: "סטים תואמים של שרשרת ועגילים, מתאימים למתנה ולאירועים.",
...
export const seedCollections = [
  {
    slug: "essentials",
    name: "Essentials",
    description: "פריטי בסיס קלאסיים לענידה יומיומית.",
  ...
  },
  {
    slug: "timeless",
    name: "Timeless",
    description: "עיצובים קלאסיים שאינם יוצאים מהאופנה.",
  ...
  },
  {
    slug: "minimal",
    name: "Minimal",
    description: "עיצובים עדינים ומינימליסטיים.",
  ...
  },
  {
    slug: "hearts",
    name: "Hearts",
    description: "תכשיטים בעיצוב לב, מתאימים במיוחד למתנה.",
  ...
  },
  {
    ...
    description: "תכשיטים מוקפדים שמשדרגים כל לוק יומיומי.",
  ...
  },
  {
    slug: "pearls",
    name: "Pearls",
    description: "תכשיטי פנינים בעיצוב מודרני.",
  ...
  },
  {
    slug: "tennis",
    name: "Tennis",
    description: "צמידי ושרשראות טניס משובצים, ליום ולערב.",
    heroImageUrl: "/brand/boutique/category-bracelets.avif",
    isFeatured: false,
  },
  {
    slug: "drops",
    name: "Drops",
    description: "עגילים תלויים בעיצוב טיפה.",
    heroImageUrl: "/brand/boutique/category-earrings.avif",
    isFeatured: false,
  },
  {
    slug: "bridal",
    name: "Bridal",
    description: "תכשיטים וסטים לכלות ולאירועים מיוחדים.",
    heroImageUrl: "/brand/boutique/category-rings.avif",
    isFeatured: false,
  },
  {
    slug: "gifts",
    name: "Gifts",
    description: "מבחר פריטים שמתאימים במיוחד למתנה.",
